...
export function MediaSlot({ label, src = null, tall = false, fill = false, fit = 'object-cover', compact = false, padded = false }) {
  if (src) {
    return <MediaImage src={src} alt={label} tall={tall} fill={fill} fit={fit} compact={compact} padded={padded} />;
  }
